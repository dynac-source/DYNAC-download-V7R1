...
DYNAC input file for the SNS H- MEBT (Medium Energy Beam Transport) line and DTL Tank 1 (text format) [sns_mebt_dtl1.txt](https://github.com/dynac-source/DYNAC-download/files/6633742/sns_mebt_dtl1.txt)  and [sns.in](https://github.com/dynac-source/DYNAC-download/blob/main/sns_mebt_dtl1.in)
